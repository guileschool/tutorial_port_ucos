                        ...
                        INT16U              opt)
{
    ...
    *--p_stk  = (OS_STK)p_arg;                                  /* R0 : argument                                          */
    ...
    if ((opt & OS_TASK_OPT_SAVE_FP) != (INT16U)0) {
       ...
       *--p_stk = (OS_STK)(OS_CPU_ARM_BIT_FPEXC_EN);            /* Initialize Floating-Point Exception Register (Enable)   */
    } else {
       *--p_stk = (OS_STK)0;                                    /* Initialize Floating-Point Exception Register (Disable)  */
       *--p_stk = (OS_STK)0;                                    /* Initialize Floating-Point Exception Register (Disable)  */
    }
#endif
